  ...
  <div align="center" style="padding:70px;">
    <table>
        ...
        <tr style="background-color:black;" align="center">
            ...
            <td style="padding:10px; color:white;"><a class="bt btn-danger" onclick="return confirm('are you sure to delete this')" href="{{url('cancel_appoint', $appoints->id)}}">Cancel</a></td>
        </tr>
        @endforeach
    </table>
  </div>
